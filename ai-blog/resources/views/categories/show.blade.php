        ...
        <div class="mb-8">
            <nav class="flex mb-4" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    <li class="inline-flex items-center">
                        <a href="{{ route('categories.index') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-white">
                            Categories
                        </a>
                    </li>
                    <li>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mt-2">{{ $posts->total() }} {{ Str::plural('post', $posts->total()) }} found</p>
                </div>
                
                <div class="bg-indigo-100 dark:bg-indigo-900 text-indigo-800 dark:text-indigo-200 px-4 py-2 rounded-lg">
                    <span class="text-sm font-medium">{{ $category->name }} Category</span>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            @empty
                <div class="col-span-full text-center py-12">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No posts in this category</h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Be the first to create a post in {{ $category->name }}.</p>
                    @auth
                        <div class="mt-6">
